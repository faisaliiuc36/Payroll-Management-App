namespace HomeTextileApp
{
	partial class Salary_Report
	{
		...
		private void InitializeComponent()
		{
			...
			this.viewSalarySheetBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.viewSalarySheetDataGridView = new System.Windows.Forms.DataGridView();
			...
			((System.ComponentModel.ISupportInitialize)(this.viewSalarySheetBindingSource)).BeginInit();
			((System.ComponentModel.ISupportInitialize)(this.viewSalarySheetDataGridView)).BeginInit();
			this.SuspendLayout();
			// 
			// groupBox2
			// 
			...
			// 
			// viewSalarySheetBindingSource
			// 
			this.viewSalarySheetBindingSource.DataSource = typeof(HomeTextileApp.DL.ViewSalarySheet);
			// 
			// viewSalarySheetDataGridView
			// 
			this.viewSalarySheetDataGridView.AutoGenerateColumns = false;
			this.viewSalarySheetDataGridView.ColumnHeadersHeightSizeMode = System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			this.viewSalarySheetDataGridView.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
			...
			this.viewSalarySheetDataGridView.DataSource = this.viewSalarySheetBindingSource;
			this.viewSalarySheetDataGridView.Location = new System.Drawing.Point(3, 133);
			this.viewSalarySheetDataGridView.Name = "viewSalarySheetDataGridView";
			this.viewSalarySheetDataGridView.Size = new System.Drawing.Size(797, 267);
			this.viewSalarySheetDataGridView.TabIndex = 5;
			// 
			...
			// 
			this.dataGridViewTextBoxColumn3.DataPropertyName = "SalaryDays";
			this.dataGridViewTextBoxColumn3.HeaderText = "SalaryDays";
			this.dataGridViewTextBoxColumn3.Name = "dataGridViewTextBoxColumn3";
			// 
			// dataGridViewTextBoxColumn4
			// 
			this.dataGridViewTextBoxColumn4.DataPropertyName = "Absent";
			this.dataGridViewTextBoxColumn4.HeaderText = "Absent";
			this.dataGridViewTextBoxColumn4.Name = "dataGridViewTextBoxColumn4";
			// 
			// dataGridViewTextBoxColumn5
			// 
			this.dataGridViewTextBoxColumn5.DataPropertyName = "Leave";
			this.dataGridViewTextBoxColumn5.HeaderText = "Leave";
			...
			// 
			this.dataGridViewTextBoxColumn8.DataPropertyName = "Conv";
			this.dataGridViewTextBoxColumn8.HeaderText = "Conv";
			this.dataGridViewTextBoxColumn8.Name = "dataGridViewTextBoxColumn8";
			// 
			// dataGridViewTextBoxColumn9
			// 
			this.dataGridViewTextBoxColumn9.DataPropertyName = "Medical";
			this.dataGridViewTextBoxColumn9.HeaderText = "Medical";
			this.dataGridViewTextBoxColumn9.Name = "dataGridViewTextBoxColumn9";
			// 
			// dataGridViewTextBoxColumn10
			// 
			this.dataGridViewTextBoxColumn10.DataPropertyName = "Other";
			this.dataGridViewTextBoxColumn10.HeaderText = "Other";
			this.dataGridViewTextBoxColumn10.Name = "dataGridViewTextBoxColumn10";
			// 
			// dataGridViewTextBoxColumn11
			// 
			this.dataGridViewTextBoxColumn11.DataPropertyName = "Gross";
			this.dataGridViewTextBoxColumn11.HeaderText = "Gross";
			this.dataGridViewTextBoxColumn11.Name = "dataGridViewTextBoxColumn11";
			// 
			// dataGridViewTextBoxColumn12
			// 
			this.dataGridViewTextBoxColumn12.DataPropertyName = "Bonus";
			this.dataGridViewTextBoxColumn12.HeaderText = "Bonus";
			this.dataGridViewTextBoxColumn12.Name = "dataGridViewTextBoxColumn12";
			// 
			// dataGridViewTextBoxColumn13
			// 
			this.dataGridViewTextBoxColumn13.DataPropertyName = "DAdvance";
			this.dataGridViewTextBoxColumn13.HeaderText = "DAdvance";
			this.dataGridViewTextBoxColumn13.Name = "dataGridViewTextBoxColumn13";
			// 
			// dataGridViewTextBoxColumn14
			// 
			this.dataGridViewTextBoxColumn14.DataPropertyName = "DLoan";
			this.dataGridViewTextBoxColumn14.HeaderText = "DLoan";
			this.dataGridViewTextBoxColumn14.Name = "dataGridViewTextBoxColumn14";
			// 
			// dataGridViewTextBoxColumn15
			// 
			this.dataGridViewTextBoxColumn15.DataPropertyName = "DAbsent";
			this.dataGridViewTextBoxColumn15.HeaderText = "DAbsent";
			this.dataGridViewTextBoxColumn15.Name = "dataGridViewTextBoxColumn15";
			// 
			// dataGridViewTextBoxColumn16
			// 
			this.dataGridViewTextBoxColumn16.DataPropertyName = "DFood";
			this.dataGridViewTextBoxColumn16.HeaderText = "DFood";
			this.dataGridViewTextBoxColumn16.Name = "dataGridViewTextBoxColumn16";
			// 
			// dataGridViewTextBoxColumn17
			// 
			this.dataGridViewTextBoxColumn17.DataPropertyName = "DStamp";
			this.dataGridViewTextBoxColumn17.HeaderText = "DStamp";
			this.dataGridViewTextBoxColumn17.Name = "dataGridViewTextBoxColumn17";
			// 
			// dataGridViewTextBoxColumn18
			// 
			this.dataGridViewTextBoxColumn18.DataPropertyName = "DTax";
			this.dataGridViewTextBoxColumn18.HeaderText = "DTax";
			this.dataGridViewTextBoxColumn18.Name = "dataGridViewTextBoxColumn18";
			// 
			// dataGridViewTextBoxColumn19
			// 
			this.dataGridViewTextBoxColumn19.DataPropertyName = "NetSalary";
			this.dataGridViewTextBoxColumn19.HeaderText = "NetSalary";
			...
			this.button2.Location = new System.Drawing.Point(724, 401);
			...
			this.Controls.Add(this.viewSalarySheetDataGridView);
			...
			((System.ComponentModel.ISupportInitialize)(this.viewSalarySheetBindingSource)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.viewSalarySheetDataGridView)).EndInit();
		...
		private System.Windows.Forms.BindingSource viewSalarySheetBindingSource;
		private System.Windows.Forms.DataGridView viewSalarySheetDataGridView;
