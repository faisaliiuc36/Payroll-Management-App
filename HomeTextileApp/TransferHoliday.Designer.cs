namespace HomeTextileApp
{
	partial class TransferHoliday
	{
		...
		private void InitializeComponent()
		{
			...
			this.button3.Location = new System.Drawing.Point(556, 55);
			...
			// groupBox3
			// 
			this.groupBox3.Controls.Add(this.emp_CheckInOutDataGridView);
			this.groupBox3.Controls.Add(this.button2);
			this.groupBox3.Location = new System.Drawing.Point(3, 111);
			this.groupBox3.Name = "groupBox3";
			this.groupBox3.Size = new System.Drawing.Size(807, 444);
			...
			this.emp_CheckInOutDataGridView.Location = new System.Drawing.Point(9, 19);
			this.emp_CheckInOutDataGridView.Name = "emp_CheckInOutDataGridView";
			this.emp_CheckInOutDataGridView.Size = new System.Drawing.Size(749, 382);
			this.emp_CheckInOutDataGridView.TabIndex = 13;
			// 
			...
			// 
			this.dataGridViewTextBoxColumn7.DataPropertyName = "OT";
			this.dataGridViewTextBoxColumn7.HeaderText = "OT";
			this.dataGridViewTextBoxColumn7.Name = "dataGridViewTextBoxColumn7";
			// 
			// emp_CheckInOutBindingSource
			// 
			this.emp_CheckInOutBindingSource.DataSource = typeof(HomeTextileApp.DL.Emp_CheckInOut);
			// 
			// button2
			// 
			...
			this.Name = "TransferHoliday";
			this.Text = "TransferHoliday";
			this.Load += new System.EventHandler(this.TransferHoliday_Load);
