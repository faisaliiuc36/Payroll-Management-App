...
{
	partial class AttendanceSectionWise
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.viewAttendanceDataGridView.Location = new System.Drawing.Point(3, 132);
			...
			this.viewAttendanceDataGridView.TabIndex = 4;
			// 
			...
			this.Name = "AttendanceSectionWise";
			this.Text = "AttendanceSectionWise";
